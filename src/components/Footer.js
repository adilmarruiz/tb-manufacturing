...
function Footer()
{
    return(
        <footer className="bg-neutral-900 text-center text-white">
            <div className="pt-3">
                <div className="mb-1 block md:flex justify-center items-center space-x-2 ">
                    <div className="flex justify-center items-center space-x-2">
                        <a href="mailto:sales@tbmanufacturing.com?subject=Information products&body=I saw your products in your page!" type="button"
                            className="m-1 h-10 w-10 rounded-full border-2 border-white uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0"
